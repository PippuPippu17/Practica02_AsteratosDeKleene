...
public class Cliente {
    ...
    /**
     * Convierte una instancia de Cliente a una cadena de texto en el formato CSV que elegimos (separar con comas).
     * 
    ...
    /**
     * Método que recostruye una instancia de Cliente a partir de una línea de texto del archvio CSV.
     * 
     ...
     * 
     * @throws IllegalArgumentException Si la línea CSV no tiene el número mínimo de columnas requeridas.
     * @throws NumberFormatException Si los valores numéricos (ID, fechaNac, edad o teléfono) no tienen un formato válido para ser convertidos.
     */
